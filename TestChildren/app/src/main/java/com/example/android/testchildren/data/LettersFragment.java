...
public class LettersFragment extends Fragment {
    ...
    public static LettersFragment newInstance(int page) {
    ...
    //Верстаем макет по типу fragment_lettersers.xml
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View result = inflater.inflate(R.layout.fragment_letters, container, false);
